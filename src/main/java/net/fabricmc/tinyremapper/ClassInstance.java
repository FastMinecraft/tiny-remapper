...
public final class ClassInstance implements TrClass {
     ...
     */
    static boolean isAssignableFrom(
        String superDesc,
        int superDescStart,
        String subDesc,
        int subDescStart,
    ...
    private static <T extends TrMember> boolean matches(
        T member,
        String name,
        String desc,
    ...
    private static <T extends TrMember> void addMatching(
        T member,
        String name,
        String desc,
        boolean isDescPrefix,
     ...
     */
    void propagate(
        MemberType type, String originatingCls, String idSrc, String nameDst,
    ...
    @Override
    public ObjectCollection<TrField> getFields(
        String name,
        String desc,
        boolean isDescPrefix,
    ...
    @Override
    public ObjectCollection<TrMethod> getMethods(
        String name,
        String desc,
        boolean isDescPrefix,
    ...
    @Override
    public ObjectCollection<TrField> resolveFields(
        String name,
        String desc,
        boolean isDescPrefix,
        Predicate<TrField> filter,
    ...
    @Override
    public ObjectCollection<TrMethod> resolveMethods(
        String name,
        String desc,
        boolean isDescPrefix,
        Predicate<TrMethod> filter,
        ...
        mapLoop:
        for (ObjectList<TrMethod> matchedMethods : matchedMethodsMap.values()) {
